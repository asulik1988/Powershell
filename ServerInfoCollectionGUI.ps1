...
[native.win]::ShowWindow(([System.Diagnostics.Process]::GetCurrentProcess() | Get-Process).MainWindowHandle, 0)
    ...
    $Loadform = new-object Windows.Forms.Form
    $Loadform.Text = "Server Collection tool is loading..."
    $Loadform.width = 400
    $Loadform.height = 300
    $LoadpictureBox = new-object Windows.Forms.PictureBox
    $LoadpictureBox.Width = 400
    $LoadpictureBox.Height = 300
    $Loadfile = (get-item "..\images\Loading.gif")
    $LoadpictureBox.Image = [System.Drawing.Image]::Fromfile($file)
    $Loadform.controls.add($LoadpictureBox)
    $Loadform.Add_Shown( { $form.Activate() } )
    $Loadform.ShowDialog()
             $wshell = New-Object -ComObject Wscript.Shell
            $wshell.Popup("After Loading before generate form",0,"Warrenty Date ERROR",0x0 + 16)
            #>
#Generated Form Function
function GenerateForm {
            $wshell = New-Object -ComObject Wscript.Shell
            $wshell.Popup("Form generated",0,"Warrenty Date ERROR",0x0 + 16)
...
$System_Drawing_Size.Height = 20
$System_Drawing_Size.Width = 150
$TechBadge.Size = $System_Drawing_Size
$TechBadge.TabIndex = 24
$TechBadge.Text = "$env:userdomain\$env:username"
...
#Show the Form
$wshell = New-Object -ComObject Wscript.Shell
            $wshell.Popup("Form generated END before show dialog",0,"Warrenty Date ERROR",0x0 + 16)
